 ...
 * </pre>
 */
package com.tdxtxt.baselib.view.container.delegate;
...
public final class RatioLayoutDelegate<TARGET extends View & RatioMeasureDelegate> {
    ...
    public static <TARGET extends View & RatioMeasureDelegate> RatioLayoutDelegate obtain(TARGET target) {
        return obtain(target, null, 0);
    }
