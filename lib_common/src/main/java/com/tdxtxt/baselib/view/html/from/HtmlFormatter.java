...
/**
 * <a href="https://github.com/SufficientlySecure/html-textview"/>
 */
public class HtmlFormatter {
    ...
    public static Spanned formatHtml(@NonNull final HtmlFormatterBuilder builder) {
        return formatHtml(
            ...
            builder.getDrawTableLinkSpan(), new TagClickListenerProvider() {
                    ...
                    @Override
                    public OnClickImgTagListener provideImgClickListener() {
                        return builder.getOnClickImgTagListener();
                    }
                }, builder.getIndent(),
    ...
    interface TagClickListenerProvider {
        ...
        OnClickImgTagListener provideImgClickListener();
    }
