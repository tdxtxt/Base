package com.tdxtxt.baselib.view.sortbar;
 ...
 *     author : tangdexiang
 *     time   : 2023-12-27
 *     desc   : 字母排序索引栏，参考 https://www.jianshu.com/p/94c682782f01
 * </pre>
 */
public class CharSortBar extends View {
    ...
    public CharSortBar(Context context) {
        super(context);
    }

    public CharSortBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);

        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CharSortBar);
        mTextColorChoose = ta.getColor(R.styleable.CharSortBar_sortbarSelectTextColor, Color.parseColor("#2E56D7"));
        mTextSizeChoose = ta.getDimension(R.styleable.CharSortBar_sortbarSelectTextSize, SizeUtils.dp2px(12));

        mTextColor = ta.getColor(R.styleable.CharSortBar_sortbarNormalTextColor, Color.parseColor("#E526D7"));
        mTextSize = ta.getDimension(R.styleable.CharSortBar_sortbarNormalTextSize, SizeUtils.dp2px(12));
