...
public class LinkedPopupWindow extends PopupWindow implements ILinked.IPopupWindow {
    ...
    private void initView(View rootView) {
        ...
        llWin.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
        ...
        picker.setOnPickedListener(new OnPickedListener() {
            @Override
            public void onPicked(ILinked linkView, PickerResult selectIds) {
        ...
        rootView.findViewById(R.id.bkgWin).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onCancel();
            }
