package com.tdxtxt.base.adapter;
 ...
 * </pre>
 */
public class FragmentAdapter<T extends Fragment> extends
        RecyclerView.Adapter<FragmentAdapter.FragmentViewHolder> implements StatefulAdapter {
    ...
    private FragmentAdapter.FragmentMaxLifecycleEnforcer mFragmentMaxLifecycleEnforcer;
    ...
    public FragmentAdapter(FragmentActivity fa, List<Pair<String, T>> list){
        this(fa);
        this.list = list;
     ...
     *
     * @see FragmentAdapter#FragmentAdapter(Fragment)
     * @see FragmentAdapter#FragmentAdapter(FragmentManager, Lifecycle)
     */
     ...
     *
     * @see FragmentAdapter#FragmentAdapter(FragmentActivity)
     * @see FragmentAdapter#FragmentAdapter(FragmentManager, Lifecycle)
     */
    ...
    public void onAttachedToRecyclerView(@NonNull RecyclerView recyclerView) {
        mFragmentMaxLifecycleEnforcer = new FragmentAdapter.FragmentMaxLifecycleEnforcer();
    ...
    public Fragment createFragment(int position){
        return list == null ? null: list.get(position).second;
    }
...
//            mViewPager.registerOnPageChangeCallback(mPageChangeCallback);
            ...
            mDataObserver = new FragmentAdapter.DataSetChangeObserver() {
                @Override
...
//            viewPager.unregisterOnPageChangeCallback(mPageChangeCallback);
    ...
    final static class FragmentViewHolder extends RecyclerView.ViewHolder {
