...
object StateLayoutConfig {
    ...
    var loadingLayoutId = R.layout.baselib_statelayout_loading
    var emptyLayoutId = R.layout.baselib_statelayout_empty
    var errorLayoutId = R.layout.baselib_statelayout_error
