package com.tdxtxt.baselib.view.titlebar.style;
...
import com.tdxtxt.baselib.view.titlebar.SelectorDrawable;
...
public class LightBarStyle extends CommonBarStyle {
    ...
    public Drawable createBackIcon(Context context) {
        return getDrawableResources(context, R.drawable.base_icon_arrow_back_black);
    }
}