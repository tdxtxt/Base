...
public class RecyclerViewFragmentAdapter<T extends Fragment> extends
    ...
    public Fragment createFragment(int position){
        return mListFragment == null ? null: mListFragment.get(position).second;
    }
    ...
    public <F extends Fragment> F getChildFragment(int position){
        if(mFragmentManager == null) return null;
        return (F) mFragmentManager.findFragmentByTag(String.format("f%s", position));
    }
