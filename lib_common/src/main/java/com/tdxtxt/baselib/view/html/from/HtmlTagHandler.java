...
package com.tdxtxt.baselib.view.html.from;
    ...
    public boolean handleTag(boolean opening, String tag, Editable output, Attributes attributes) {
        if (opening) {
            ...
            if (tag.equalsIgnoreCase(UNORDERED_LIST)) {
                ...
                final String spannedText = output.subSequence(spanStart, spanEnd).toString();
                    ...
                    public void onClick(View widget) {
                        if (onClickATagListenerProvider != null) {
                            OnClickATagListener aTagListener = onClickATagListenerProvider.provideTagClickListener();
                            if(aTagListener != null){
                                boolean clickConsumed = aTagListener.onClick(widget, spannedText, getURL());
                                if (!clickConsumed) {
                ...
                if (onClickATagListenerProvider != null) {
                    OnClickImgTagListener imgTagListener = onClickATagListenerProvider.provideImgClickListener();
                    if(imgTagListener != null){
                        ...
                        if(images != null && images.length > 0){
                            ...
                            if(source != null){
                                String imgUrl = source.replaceAll("\\\\\"", "");
                                output.setSpan(new ClickableSpan(){
                                    @Override
                                    public void onClick(@NonNull View widget) {
                                        imgTagListener.onClick(imgUrl);
                                    }
