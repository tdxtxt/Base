...
class VolumeControllerView: FrameLayout, IGestureController {
    ...
    private fun initView(){
        ...
        findViewById<ImageView>(R.id.iv_volume_bright)?.setImageResource(R.mipmap.liteavlib_ic_volume)
    }
    ...
    override fun show(changePercent: Float) {
        ...
        findViewById<ImageView>(R.id.iv_volume_bright)?.setImageResource(if(newVolume == 0) R.mipmap.liteavlib_ic_volume_off else R.mipmap.liteavlib_ic_volume)
