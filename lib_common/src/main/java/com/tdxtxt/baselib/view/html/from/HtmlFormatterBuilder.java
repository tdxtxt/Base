...
public class HtmlFormatterBuilder {
    ...
    private OnClickImgTagListener onClickImgTagListener;
    ...
    public OnClickImgTagListener getOnClickImgTagListener() {
        return onClickImgTagListener;
    }
    ...
    public HtmlFormatterBuilder setOnClickImgTagListener(OnClickImgTagListener onClickImgTagListener) {
        this.onClickImgTagListener = onClickImgTagListener;
        return this;
    }
